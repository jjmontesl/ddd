...
setup(
    ...
    install_requires = [
        ...
        "pycatenary >= 0.4.0",
        "pycsg >= 0.3.3",
        "pyembree",  # Used for faster ray casting (TODO: check it is in use if available)
        "pyGeoTile >= 1.0.6",
        ...
        "scipy",  # < 1.6.0",
        "Shapely >= 1.8.1.post1",
        "trimesh[all] >= 3.22.1",  # -e git+https://github.com/mikedh/trimesh.git@8c5633028984b4abb1b7911208f7652119a3c96d#egg=trimesh
        "triangle >= 20190115.3",
