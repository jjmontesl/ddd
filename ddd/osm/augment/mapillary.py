...
class MapillaryClient():
    ...
    client_id = "WFBxUUhWTlFhOGNhanZXUWFFTVNpNzoyMmM5OTUyMWQwOTZhMDYw"
    ...
    def images_list(self, coords, limit=5):
        data = self.request("images", {'closeto': "%.6f,%.6f" % (coords[0], coords[1]), 'radius': 100, 'per_page': limit})
