...
def generate_area_items(area, group_name, item_types, item_density_m2=0.0025, item_align='noise', max_items=None):
    """
    Note that default density is low to prevent too many items being generated by default or by mistake. Adjust as per use case.
    """
    ...
    if item_align == 'noise':
        ...
        for idx, p in enumerate(item_area.random_points(num_points=num_items)):  # filter=filter_func_noise
