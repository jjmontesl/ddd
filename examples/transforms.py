...
def example_transforms(pipeline, root):
    ...
    sun.append(create_side_obj("Sun"))
    ...
    planet.append(create_side_obj("V"))
    sun.append(planet)
    ...
    # Front
    sun_front = sun.copy()
    #sun_front = sun_front.rotate(ddd.ROT_FLOOR_TO_FRONT)  #.translate([30, 0, 0])
    sun_front = sun_front.rotate([-math.pi / 2.0, 0, 0])
    #sun_front.transform.rotate(ddd.ROT_FLOOR_TO_FRONT)
    sun_front.transform.translate([30, 0, 0])  # FIXME: currently differs from .translate() !
